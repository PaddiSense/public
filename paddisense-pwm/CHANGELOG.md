...
## 2026.8.14 — the commissioning marker fails CLOSED with no evidence
...
## 2026.8.13 — Security: cryptography CVEs + PLAT-08 hash-pinned build
...
## 2026.8.12 — WR-PS-421 follow-up: write the commissioning marker at startup
...
## 2026.8.10 — WR-PS-421: an unlicensed box is not a LOCKED box
...
## 2026.8.9 — WR-PS-210: accept an operator's own deactivate from this box's console
